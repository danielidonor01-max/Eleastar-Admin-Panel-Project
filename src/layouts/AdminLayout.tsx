...
export const AdminLayout = () => {
    ...
    const toggleSubMenu = (slug: string) => {
        setExpandedSubMenuItems(prev => prev.includes(slug) ? prev.filter(s => s !== slug) : [...prev, slug]);
    };
    const isSubMenuExpanded = (slug: string) => {
        return expandedSubMenuItems.includes(slug);
    };
    ...
    const sidebarWidthClass = expandedMenu ? 'w-[280px]' : 'w-64';
                                ...
                                {hasAccess('Website CMS') && (
                                    <div className="mb-2">
                                        ...
                                        >
                                            ...
                                            {expandedMenu ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
                                        </button>
