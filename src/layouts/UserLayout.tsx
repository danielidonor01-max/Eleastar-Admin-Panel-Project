...
export const UserLayout: React.FC = () => {
    const { isAuthenticated, logout, currentUserRole } = useAdmin();
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3">
                        <div className="text-right hidden sm:block">
                            <div className="text-sm font-bold text-slate-900">User Session</div>
                            <div className="text-xs text-slate-500">user@eleastar.com</div>
                        </div>
                        <div className="w-9 h-9 bg-brand-100 rounded-full flex items-center justify-center text-brand-700 font-bold border border-brand-200">
                            US
                        </div>
                    </div>
