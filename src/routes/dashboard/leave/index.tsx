...
export const LeaveManagement=  () => {
    ...
    useEffect(() => {
        ...
        if (requestId) {
            const req = leaveRequests.find((r: LeaveRequest) => r.id === requestId);
            if (req) {
                setTimeout(() => {
                    setFilter('All');
                }, 0);
    ...
    }).sort((a: LeaveRequest, b: LeaveRequest) => new Date(b.requestedAt).getTime() - new Date(a.requestedAt).getTime());
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-2xl font-bold text-amber-600">{leaveRequests.filter((r: LeaveRequest) => r.status === 'Pending').length}</p>
                    </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-2xl font-bold text-green-600">{leaveRequests.filter((r: LeaveRequest) => r.status === 'Approved').length}</p>
                    </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-2xl font-bold text-red-600">{leaveRequests.filter((r: LeaveRequest) => r.status === 'Rejected').length}</p>
                    </div>
