...
export const AdminTasksPage = () => {
    ...
    const handleCreateTask = (e: React.SyntheticEvent<HTMLFormElement>) => {
        e.preventDefault();
        createTask({
            title,
            description,
        ...
        toast.success('Task Created', { description: 'The task has been successfully assigned.' });
    ...
    const handleMarkComplete = (taskId: string) => {
        showConfirm({
            ...
            onConfirm: () => {
                ...
                toast.success('Task Completed', { description: 'The task has been finalized and logged.' });
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-3xl font-bold text-brand-600">{tasks.filter((t: Task) => t.status === 'In Progress').length}</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-3xl font-bold text-amber-600">{tasks.filter((t: Task) => t.status === 'In Review').length}</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-3xl font-bold text-emerald-600">{tasks.filter((t: Task) => t.status === 'Completed').length}</p>
                    </div>
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 mb-6 flex flex-col md:flex-row gap-4 justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        value={statusFilter}
                        onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setStatusFilter(e.target.value as Task['status'])}
