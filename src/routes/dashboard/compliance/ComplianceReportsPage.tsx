...
export function ComplianceReportsPage() {
    ...
    const generatePayrollSummaryReport = useAuditStore((s) => s.generatePayrollSummaryReport);
    const generateApprovalTrailReport = useAuditStore((s) => s.generateApprovalTrailReport);
    const generateBonusAdjustmentReport = useAuditStore((s) => s.generateBonusAdjustmentReport);
    const generatePayrollVarianceReport = useAuditStore((s) => s.generatePayrollVarianceReport);
    const generateSalaryHistoryReport = useAuditStore((s) => s.generateSalaryHistoryReport);
    const generatePromotionHistoryReport = useAuditStore((s) => s.generatePromotionHistoryReport);
    const generateUserAccessReport = useAuditStore((s) => s.generateUserAccessReport);
    const generateCriticalActionReport = useAuditStore((s) => s.generateCriticalActionReport);
    const generateAttestationPack = useAuditStore((s) => s.generateAttestationPack);
    ...
    const handleExportCSV = () => {
        ...
        toast.success('Export Complete', { description: `${reportName} exported as CSV successfully` });
    };
    ...
    const handleExportPDF = () => {
        ...
        toast.success('Export Complete', { description: `${reportName} prepared for PDF export` });
    };
    ...
    const handleGenerateAttestationPack = () => {
        ...
        toast.success('Attestation Pack Generated', { description: `${reports.length} reports exported` });
    };
