...
import type { PromotionRequest, AdminRole, PromotionEligibilityRule } from '../../data/mockData';
...
export const PromotionsPage: React.FC = () => {
    ...
    const filteredRequests = promotionRequests.filter(req => {
                            ...
                            {eligibilityCheck && (
                                <div className={`p-3 rounded-lg border text-sm ${eligibilityCheck.isEligible ? 'bg-green-50 border-green-200 text-green-800' : 'bg-amber-50 border-amber-200 text-amber-800'}`}>
                                    ...
                                    <div className="mt-2 text-xs flex gap-3 text-gray-500">
                                        <span>Performance: <strong>{eligibilityCheck.scores.performance} / 5</strong></span>
                                        <span>Tenure: <strong>{eligibilityCheck.scores.tenureMonths} months</strong></span>
                                    </div>
                                </div>
                            )}
                        ...
                        <form onSubmit={handleRuleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={e => setRuleFormData({ ...ruleFormData, targetRole: e.target.value as any })}
                                >
