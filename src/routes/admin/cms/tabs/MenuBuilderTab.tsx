...
const MenuBuilderTab = () => {
    ...
    const loadMenus = useCallback(async () => {
        ...
        try {
            ...
            showError({ title: 'Error', message: 'Failed to load menus.' });
        } finally { setLoading(false); }
    }, [selectedMenu, showError]);
    ...
    const loadMenuItems = useCallback(async (key: string) => {
        ...
        try {
            ...
            showError({ title: 'Error', message: 'Failed to load menu items.' });
            setMenuItems([]); 
    ...
    const handleToggleVisibility = async (item: CMSMenuItem) => {
        try {
            ...
            showError({ title: 'Error', message: 'Failed to toggle visibility.' });
        }
    };
