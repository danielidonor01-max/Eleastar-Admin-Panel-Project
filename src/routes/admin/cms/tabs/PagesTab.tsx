...
const PagesTab = () => {
    ...
    const loadPages = useCallback(async () => {
        try {
            ...
            showError({ title: 'Error', message: 'Failed to load pages.' });
        }
    }, [showError]);
    ...
    const loadSections = useCallback(async (slug: string) => {
        ...
        try {
            ...
            showError({ title: 'Error', message: 'Failed to load sections.' });
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setIsDirty(false);
        } catch (e: unknown) { showError({ title: 'Publish Failed', message: e instanceof Error ? e.message : 'Unknown error' }); }
    };
    ...
    const handleCreate = async () => {
        ...
        } catch (e: unknown) { showError({ title: 'Error', message: e instanceof Error ? e.message : 'Unknown error' }); }
    };
    ...
    const handleSaveSEO = async (payload: Record<string, unknown>) => {
        ...
        try {
            ...
            showError({ title: 'SEO Save Failed', message: e instanceof Error ? e.message : 'Unknown error' });
        }
    };
