...
export const NotificationsPage: React.FC = () => {
    ...
    const FilterPill = ({ label, value }: { label: string, value: typeof activeFilter }) => (
        <button
            ...
            className={`px-4 py-2 text-sm font-bold rounded-xl border transition-all flex items-center gap-2 ${activeFilter === value
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-4 justify-between items-center">
                ...
                <div className="flex gap-2 overflow-x-auto w-full md:w-auto no-scrollbar pb-2 md:pb-0">
                    ...
                    <FilterPill label="Recruitment" value="Recruitment" />
                </div>
